...
namespace Tyuiu.Ignatov.Lab3.Review.V9
{
    internal class Program
    {
        ...
        static void Option3()
        {
            ...
            Console.WriteLine("+----------+----------+");
            double[] results = tab.GetMassFunction(start, end);
        ...
        static void OptionFS()
        {
            ...
            Console.WriteLine(" Программу разработал Игнатов Александр Вадимович | МКМб-22-1 | ТИУ 2024");
            Console.SetCursorPosition(0, 22);
            Console.WriteLine("------------------------------------------------------------------------------");
        ...
        static void drawMainMenu()
        {
            ...
            Console.WriteLine("║                     Выполнил Игнатов Александр Вадимович                  ║");
